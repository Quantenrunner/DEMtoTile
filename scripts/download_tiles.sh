...
# Search for all files with '.tar.gz' in the name and save results to a temporary file
...
while : ; do
  ...
  URL="https://www.googleapis.com/drive/v3/files?q=name%20contains%20'.tar.gz'&fields=nextPageToken,files(id,name)&pageSize=1000"
...
# Read the list of files line by line and download each .tar.gz file
while IFS= read -r line; do
  ...
  # Check if the file name ends with '.tar.gz' (case-insensitive)
